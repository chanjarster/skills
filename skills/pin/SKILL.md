---
name: pin
description: 管理项目情报（Project Information）文档系统。当需要创建、读取、更新或导航项目文档时使用，包括业务知识（需求文档、操作手册）、技术文档（架构、开发环境、代码地图、研究记录）、UI设计（设计图、切图）、规范文档（git 规范、代码规范、示例）和任务日志。在项目初始化、编写需求/技术/UI/规范文档、管理开发任务、或需要了解项目上下文时触发。
---
